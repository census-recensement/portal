...
Les listes d'autorité, ainsi que de la documentation supplémentaire sur les objectifs et l'énoncé du projet du PDDRC, sont disponibles dans le dépôt [Borealis](https://borealisdata.ca/dataverse/ccddp-pddrc). Des informations générales sont également disponibles sur le [site web du projet](https://cddp-pddr.ca/).
